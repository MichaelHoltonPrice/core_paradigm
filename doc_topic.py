...
#model_old = models.LdaModel.load('/home/sahana/lda_save/ldamodel_output100')
#model_partial = models.LdaModel.load('/home/sahana/sfi_research/lda_output/ldamodel_output100')
#getting textbooks
#path_txt = "/home/sahana/sfi_research/pickles/textbooks.pkl"
...
with open("/home/sahana/sfi_research/pickles/doc_corpus.pkl","wb") as f:
    pickle.dump(doc_corpus,f)
